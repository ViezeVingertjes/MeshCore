...
void CommonCLI::loadPrefsInt(FILESYSTEM* fs, const char* filename) {
  ...
  if (file) {
    ...
    file.read((uint8_t *) &_prefs->light_sleep_idle_secs, sizeof(_prefs->light_sleep_idle_secs));  // 128-129
    file.read((uint8_t *) &_prefs->light_sleep_slice_secs, sizeof(_prefs->light_sleep_slice_secs));  // 130
    file.read((uint8_t *) &_prefs->deep_sleep_idle_secs, sizeof(_prefs->deep_sleep_idle_secs));  // 131-132
    file.read((uint8_t *) &_prefs->deep_sleep_duration_secs, sizeof(_prefs->deep_sleep_duration_secs));  // 133-134
...
void CommonCLI::savePrefs(FILESYSTEM* fs) {
  ...
  if (file) {
    ...
    file.write((uint8_t *) &_prefs->light_sleep_idle_secs, sizeof(_prefs->light_sleep_idle_secs));  // 128-129
    file.write((uint8_t *) &_prefs->light_sleep_slice_secs, sizeof(_prefs->light_sleep_slice_secs));  // 130
    file.write((uint8_t *) &_prefs->deep_sleep_idle_secs, sizeof(_prefs->deep_sleep_idle_secs));  // 131-132
    file.write((uint8_t *) &_prefs->deep_sleep_duration_secs, sizeof(_prefs->deep_sleep_duration_secs));  // 133-134
